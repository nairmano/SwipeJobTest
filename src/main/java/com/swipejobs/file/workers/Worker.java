...
public class Worker {
     ...
     * @param availability
     */
    public Worker(Integer rating, Boolean isActive, List<String> certificates, List<String> skills, JobSearchAddress jobSearchAddress, String transportation, Boolean hasDriversLicense, List<Availability> availability, String phone, String email, Name name, Integer age, String guid, Integer userId) {
        super();
        this.rating = rating;
